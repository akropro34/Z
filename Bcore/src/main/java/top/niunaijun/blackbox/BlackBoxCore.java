...
public class BlackBoxCore extends ClientConfiguration {
    ...
    public void doAttachBaseContext(final Context context, final boolean hideRoot) {
        doAttachBaseContext(context, new ClientConfiguration() {
            @Override
    ...
    public Intent getLaunchIntent(String packageName, int userId) {
        return getBPackageManager().getLaunchIntentForPackage(packageName, userId);
    }
    ...
    public InstallResult installPackageAsUser(String packageName, InstallOption installOption, int userId) {
        try {
            ...
            return getBPackageManager().installPackageAsUser(packageInfo.applicationInfo.sourceDir, installOption, userId);
